...
2. Dark Blue - Pistol Especially effective for "1B1 Kinetic Fingers"
...
3. Purple- Shotgun- Takes one turns to charge when ammo is put in, but inflicts heavy damage: Effective for "Bulk XR"
	- A: Cone of Fire: The gun's cone width is upgraded, allowing for higher damage.
...
5. LightBlue - Sniper- high single target damage, but low multitarget damage Especially effective for "PP3 Skyjack"
...
6. Green - Grenade: High multitarget damage, low single target damage Especially effective for "Scrap rm7"
...
7. Red - Rocket Launcher- Especially effective for "Rocketeer Tr1"
	...
	- C: Energy Tracker Upgrade: New technology allows rockets to lock onto heat sources or energy sources.
...
>(optional) Event Cards: When drawn using a turn, card is unknown until played.
>>>>>>> 9b969a6 Add game concepts to readme.md
