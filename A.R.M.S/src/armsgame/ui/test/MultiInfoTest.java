...
public class MultiInfoTest extends Application{
	...
	private Stage init(String image, double y) {
		...
		Text wDescription = Tools.createText(205, 150, wRatio, hRatio, "Weapons\nManager",  Color.web("#135ca8").brighter(), smallShade,Tools.createRegularFont(12, sRatio));
		...
		Rectangle shieldBar = Tools.createRoundedRectangle((168)*shieldScale.getValue()
				,20,5,5,86,112.5,sRatio, wRatio, hRatio,Color.WHITE, null);
		...
		Rectangle energyBar = Tools.createRoundedRectangle((168)*energyScale.getValue()
				,20,5,5,86,80,sRatio, wRatio, hRatio,Color.WHITE, null);
