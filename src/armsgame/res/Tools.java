...
public class Tools {
	static {
		Font.loadFont(ClassLoader.getSystemResourceAsStream("armsgame/res/Xolonium-Regular.otf"), 10);
		Font.loadFont(ClassLoader.getSystemResourceAsStream("armsgame/res/Xolonium-Bold.otf"), 10);
	}
	...
	public static Image createImage(String res) {
		return new Image(ClassLoader.getSystemResourceAsStream("armsgame/res/" + res));
	}
